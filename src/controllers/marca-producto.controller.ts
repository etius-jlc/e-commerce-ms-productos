...
export class MarcaProductoController {
  ...
  async find(
    ...
    return this.marcaRepository.y(id).find(filter);
  }
  ...
  async create(
    ...
    return this.marcaRepository.y(id).create(producto);
  }
  ...
  async patch(
    ...
    return this.marcaRepository.y(id).patch(producto, where);
  }
  ...
  async delete(
    ...
    return this.marcaRepository.y(id).delete(where);
  }
}
